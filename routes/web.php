...
Route::get('banned', 'PageController@banned');
...
Route::group(['middleware' => 'banned'], function () {
    ...
    Route::get('search', 'PageController@textSearch');
    ...
    Route::get('admin/users/ban/{id}', 'AdminController@userCreateBan');
    Route::post('admin/users/ban/{id}', 'AdminController@userBan');
